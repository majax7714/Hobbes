...
**Hobbes 0.2.18-beta** (2026-09-14). The Hobbes layer is versioned from here
...
dispatched on 2026-09-12, and twenty-six session logs stand through
0.2.18-beta. The tracker at the end of
...
parallel (0.2.18-beta, ADR-113; wired, not supported until its row).
