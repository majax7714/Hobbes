...
dispatched on 2026-09-12, and fifty-eight session logs stand. The
...
| [`docs/adr/`](docs/adr/) | ADR-001 to ADR-140 (106 closed as *not taken*) — one per decision the running architecture doesn't make |
