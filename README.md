...
**Hobbes 0.2.19-beta** (2026-09-14). The Hobbes layer is versioned from here
...
The constraint register holds one hundred and forty-seven entries (one
hundred and four active, twenty-six lifted, eleven superseded, six
...
dispatched on 2026-09-12, and twenty-seven session logs stand through
0.2.19-beta. The tracker at the end of
...
(0.2.19-beta; wired, not supported until its row).
