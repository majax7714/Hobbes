...
**Hobbes 0.2.13-beta** (2026-09-13). The Hobbes layer is versioned from here
...
(0.2.12-beta), and C tests found by their Unity, CMocka and Check
registrations (0.2.13-beta).
