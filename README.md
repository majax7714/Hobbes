...
value bound to a local and a base's method: flask 41.5% → 56.4%; and
four wrong edges the Python index's shared names produced, refused rather
than guessed, ADR-150), and JavaScript's graded rules (ADR-141
