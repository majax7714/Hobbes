...
**Hobbes 0.2.66-beta** (2026-09-20). The Hobbes layer is versioned from here
...
constructs, ADR-145, and a decorator's calls, ADR-146 and ADR-147: click's
recall 38.2% → 73.0%, at no contradiction),
