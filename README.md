...
**Hobbes 0.2.12-beta** (2026-09-13). The Hobbes layer is versioned from here
...
dispatched on 2026-09-12, and fourteen session logs stand through
0.2.12-beta. The harness counts as validated after 40 sessions (Max,
...
(0.2.10-beta), a session contained to its own dir (0.2.11-beta) and
