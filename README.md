...
**Hobbes 0.2.25-beta** (2026-09-15). The Hobbes layer is versioned from here
...
| [`docs/adr/`](docs/adr/) | ADR-001 to ADR-115 (106 closed as *not taken*) — one per decision the running architecture doesn't make |
