...
**Hobbes 0.1.5-beta** (2026-09-10). The Hobbes layer is versioned from here
...
The constraint register holds ninety-nine entries (seventy-five
active, twenty-two lifted, two superseded), each naming where a user meets
the limit.
...
| [`docs/adr/`](docs/adr/) | 104 numbered ADRs — one per decision the running architecture doesn't make |
