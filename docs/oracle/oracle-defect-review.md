...
| RC-5 | Ratio quoted with unlabeled over-approximation or mismatched denominator | H-4, H-14, H-22 | 3 | closed-policy | Split by class, label inflation; numerator and denominator from one index. Log rule 2. H-22 was a violation for a day: the exploratory bucket merged distinct identities; fixed and measured 2026-09-10 (later) — 0 / 3 pairs, no hit moved. |
