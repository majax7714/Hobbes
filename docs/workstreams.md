...
- ~~**Python's decorator and fixture-value calls (Max, 2026-09-20:
  ...
  factory's guards folded over the site's arguments, 81.2% (§10.33). Open
  from it: click's 858 remaining misses (512 closures — callbacks reached
  through attributes and parameters, `group()`'s chain — 215 methods, 81
  lambdas), C-4's fixture value through a local, each measured first
  (`session-handoff.md`).
