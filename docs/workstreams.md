...
- ~~**Python's decorator and fixture-value calls (Max, 2026-09-20:
  ...
  41.5% → 56.4% (§10.35). Open from it: flask's 3 Hobbes-wrong nested-def
  edges (cause first).
