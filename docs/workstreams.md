...
- ~~**Python's decorator and fixture-value calls (Max, 2026-09-20:
  ...
  parameters — 215 methods, 81 lambdas), C-4's fixture value through a local, each measured first
  (`session-handoff.md`).
