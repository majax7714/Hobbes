...
45 of 40 sessions · areas: extraction, knowledge tools, oracle lane, harness and sandbox (4; at least 3) · false blocks 1 · missed 0
refusals: egress 51, policy escalations 116, denies 0 (each read in its session's notes, §4)
reported cost $165.58 over 44 of 45 sessions (the envelope's figure, on the subscription) · turns 2505 · wall 454 min
