...
49 of 40 sessions · areas: extraction, knowledge tools, oracle lane, harness and sandbox (4; at least 3) · false blocks 1 · missed 0
refusals: egress 57, policy escalations 130, denies 0 (each read in its session's notes, §4)
reported cost $190.15 over 48 of 49 sessions (the envelope's figure, on the subscription) · turns 2798 · wall 493 min
