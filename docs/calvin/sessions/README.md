...
52 of 40 sessions · areas: extraction, knowledge tools, oracle lane, harness and sandbox (4; at least 3) · false blocks 1 · missed 0
refusals: egress 61, policy escalations 132, denies 0 (each read in its session's notes, §4)
reported cost $206.38 over 51 of 52 sessions (the envelope's figure, on the subscription) · turns 2967 · wall 528 min
