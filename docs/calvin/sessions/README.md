...
32 of 40 sessions · areas: extraction, knowledge tools, oracle lane, harness and sandbox (4; at least 3) · false blocks 1 · missed 0
refusals: egress 32, policy escalations 68, denies 0 (each read in its session's notes, §4)
reported cost $118.89 over 31 of 32 sessions (the envelope's figure, on the subscription) · turns 1789 · wall 360 min
