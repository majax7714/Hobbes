...
schema. Its lane B is scip-clang already (the same derived database
indexes every unit a root's build names, C++ included, wherever a root
has a C file — unit 2 makes it deliberate), and its oracle O10 is the C
oracle's C++ face (§7d). Wired, not supported, until its cells.
...
**Hobbes 0.2.18-beta** (2026-09-14, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.18-beta untagged; `CHANGELOG.md` is the
