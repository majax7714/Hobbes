...
`tssource`, `gosource`, `rustsource`, `javasource`, `csource`, and HCL's). The claim that was wrong
...
**Hobbes 0.2.17-beta** (2026-09-14, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.17-beta untagged; `CHANGELOG.md` is the
