...
C++'s fmt reads 99.85% (99.66% judged like-for-like), and every
contradiction left on it is Hobbes' own: 4 are scip-clang's wrong
candidate at a call in a template (C-153), 6 more of that same defect
are unjudged rather than fixed, and 1 is a call drawn inside an
unevaluated operand (C-155). All four of the oracle's own defects on
this cell — H-28, H-29, H-30 and H-31 — were fixed on 2026-09-16 and the
cells regraded. C's
