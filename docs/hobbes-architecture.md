...
**Hobbes 0.2.9-beta** (2026-09-13, ADR-103; beta: graded, not stable; the last tag is `v0.1.8-beta`, 0.1.9-beta to 0.2.9-beta untagged; `CHANGELOG.md` is the
