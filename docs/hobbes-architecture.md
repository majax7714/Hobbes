...
stands at 100% precision-against-oracle except two, quic-go (99.6% lower
bound, every contradiction oracle-grain, 0 hobbes-wrong) and C's
sqlite-vector (99.6%: three syntactic edges hobbes-wrong, C-138; the
semantic tier 851/851) — ajv's three
