...
| **Go** | **one repo — this one** | 813 call edges, 20/20 hand-verified; 216 nodes (V2.M5). **Compiler-graded 2026-08-25 (oracle lane O2):** 1,278/1,278 semantic call edges confirmed by RTA, 0/3 syntactic; static-call recall 1,280/1,280 at 20 roots; calls through interfaces, function values and into closures are drawn for none of 45 (C-58). Licenses this repo's Go zone only |
