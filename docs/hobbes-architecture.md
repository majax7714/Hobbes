...
precision on every cell. C-168 registers the rest — `super(…)`, a JSX
tag whose component declares no constructor, and a token the index does
not resolve.
