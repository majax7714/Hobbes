...
using-declaration loses its constructor's reference to the join's
by-name claim (19 rows on fmt). C-162 registers all of it (§10.17).
...
templates (ADR-131), and to 30.3% (args 72.9%) at 0.2.44-beta on
constructions drawn at the token (ADR-132). The
...
**Hobbes 0.2.44-beta** (2026-09-17, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.44-beta untagged; `CHANGELOG.md` is the
