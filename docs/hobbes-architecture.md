...
rule added was there and about 100 of 161 read wrong, so nothing is drawn
there and the ingest counts what was left (`graph.json`'s `operators`
block; C-146 narrowed, §10.15).
...
**Hobbes 0.2.42-beta** (2026-09-17, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.42-beta untagged; `CHANGELOG.md` is the
