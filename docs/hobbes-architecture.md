...
symbol says who declared it (`declared_by: "scip"`), is a **target and
not a scope** (`end_line` is its line), is spelled as the compiler
spells it, and is minted only under lane A's own contract: a function,
...
**Hobbes 0.2.45-beta** (2026-09-18, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.45-beta untagged; `CHANGELOG.md` is the
