...
**Hobbes 0.2.62-beta** (2026-09-20, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.62-beta untagged; `CHANGELOG.md` is the
