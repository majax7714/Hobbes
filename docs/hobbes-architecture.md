...
| **Terraform/HCL** | private-repo-A, this repo | cross-layer `packages` edge hand-verified at the cited line (M3); pack removability byte-for-byte (V2.M4) |
