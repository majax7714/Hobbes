...
The table is current to **2026-09-09**: every compiler-graded cell
stands at 100% precision-against-oracle except hono (767/768 — one
union-member row at a site lane A cannot type, C-98; ajv's three closed
by ADR-104's abstention) and quic-go (99.6% lower
