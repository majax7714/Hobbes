...
Wired, not supported, until its row.
...
**C's two repos arrived in one session too** (ADR-110): a library with a vendored test framework, chosen, and a random draw, both built by CMake or make with nothing fetched. Autotools, Meson and Bazel roots (C-135), C++ (C-132) and a kernel-style build are outside the sample.
...
The table is current to **2026-09-12**: every compiler-graded cell
stands at 100% precision-against-oracle except one, quic-go (99.6% lower
bound, every contradiction oracle-grain, 0 hobbes-wrong). C's
...
**Hobbes 0.2.22-beta** (2026-09-15, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.22-beta untagged; `CHANGELOG.md` is the
