...
| **TypeScript / JavaScript** | kbet (real Vite+React app), private-repo-A, this repo's `web/` | kbet: 231 semantic call edges, 20/20 hand-verified; 20/20 edges + 10/10 test mappings (M6); lane agreement 359 sites / 0. private-repo-A: 11 JS module edges + 9 call edges + 9 node:test mappings, 100% hand-verified |
