...
The table is current to **2026-09-15**: every compiler-graded cell
...
C++'s fmt reads 99.1%: 10 edges are scip-clang's own wrong candidate at
a call in a template (C-153), and 18 contradictions are the oracle's
(H-28–H-31, open). C's
...
**Hobbes 0.2.27-beta** (2026-09-15, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.27-beta untagged; `CHANGELOG.md` is the
