...
C++'s fmt reads 99.7% (99.48% judged like-for-like): 4 edges are
scip-clang's own wrong candidate at a call in a template (C-153), 6 more
of that same defect are now unjudged rather than fixed, and 7
contradictions are the oracle's (H-31, still open — H-28, H-29 and H-30
were fixed on 2026-09-16 and the cells regraded). C's
