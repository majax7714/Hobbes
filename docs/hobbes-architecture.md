...
The table is current to **2026-09-16**: every compiler-graded cell
stands at 100% precision-against-oracle except two. quic-go reads 99.6%
as a lower bound, every contradiction oracle-grain and 0 hobbes-wrong.
C++'s fmt reads 99.88% (99.69% judged like-for-like), and every
contradiction left on it is scip-clang's wrong candidate at a call in
a template (C-153; 4 judged, 6 more unjudged rather than fixed). The
...
**Hobbes 0.2.33-beta** (2026-09-16, ADR-103; beta: graded, not stable; the latest tag `v0.2.10-beta`, the one before it `v0.1.8-beta`; 0.1.9-beta to 0.2.9-beta and 0.2.11-beta to 0.2.33-beta untagged; `CHANGELOG.md` is the
