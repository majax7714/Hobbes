...
| [`extraction-typescript-javascript.md`](extraction-typescript-javascript.md) | Extraction — TypeScript and JavaScript | C-12, C-13, C-63, C-97, C-98, C-99, C-90, C-89, C-11, C-24 |
...
**Ninety-nine entries: seventy-five active, twenty-two lifted, two superseded**
(C-98 lifted and C-99 registered and lifted 2026-09-10 — the TS helper
