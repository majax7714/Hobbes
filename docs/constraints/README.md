...
|---|---|---|
| [`extraction-call-graph.md`](extraction-call-graph.md) | Extraction — the call graph | C-1, C-2, C-4, C-5, C-6, C-7, C-8, C-9, C-10, C-58, C-59, C-32, C-3 |
...
**Fifty-nine entries: fifty active, seven lifted, two superseded**
(C-58 and C-59 added 2026-08-25 by the oracle lane — unsurfaced, and the first
...
against the code that concedes it; none had been silently lifted). Four
of the active are **unsurfaced** (C-19 — narrowed to two tools — C-20,
C-58 — the interface/closure call hole, whose capture number reads
resolved — and C-59, the dropped self-call); C-4 moved from unsurfaced to *partial* in that audit, its status
