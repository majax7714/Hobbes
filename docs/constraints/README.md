...
|---|---|---|
| [`extraction-call-graph.md`](extraction-call-graph.md) | Extraction — the call graph | C-1, C-2, C-4, C-156, C-5, C-6, C-7, C-8, C-9, C-10, C-58, C-70, C-32, C-59, C-163, C-169, C-80, C-3 |
...
**One hundred and sixty-nine entries: one hundred and twenty-three active, twenty-nine lifted, eleven superseded, six folded**
