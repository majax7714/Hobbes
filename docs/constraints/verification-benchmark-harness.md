# Verification — the benchmark harness (ADR-055), the TTT experiment (ADR-099) and the Calvin M0 local harness (ADR-100)
...
- **Cannot tell you:** that a running session could not reach the
  ...
  until ADR-107 (the narrowing, further down this entry; the dispatch
  harness's own entries are in `dispatch-harness.md` since 2026-09-14).
