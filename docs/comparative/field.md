...
**Hobbes, for the same columns, so the reader has the row it is
being compared to** — every entry points at the evidence rather than
restating it: edge source, tree-sitter (lane A) joined to the
