...
1. **Hobbes draws nothing the compiler contradicts, on every
   ...
   0.2.44-beta on more than twice the edges (6,993/6,993). Its last four
...
3. **Here is how much Hobbes does not draw, and what it is.** Recall
   runs from 30.3% (C++'s fmt, over every resolved site; 14.5% before ADR-129, 29.1% before ADR-131's operators, 30.1% before ADR-132's constructions) to 100.0% (the best of dagger's
...
4. **Other tools' graphs, same keys.** CodeGraphContext 0.6.13 and
   ...
   - **Hobbes, same keys:** fmt 6,993/6,993 (**100%**; strict
     6,993/7,020, 99.62%, at 0.2.44-beta), recall 30.3%; args
     2,567/2,567, recall 72.9%. (At 0.2.42-beta: fmt 6,901/6,901, strict
