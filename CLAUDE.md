...
## Status (2026-09-10) — Hobbes 0.1.7-beta
...
- **v1 (M0–M8) and v2 extraction (V2.M0–M7) are complete and reviewed.**
  ...
  by one range join; artifacts at schema v4; 100 registered constraints
  (75 active, 23 lifted, 2 superseded).
